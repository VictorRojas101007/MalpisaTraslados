        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="w-20 bg-gray-100 rounded-xl px-4 py-3 text-sm text-gray-800 border-0 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="button"
              onClick={agregarProducto}
              className="bg-gray-900 text-white text-lg font-bold w-12 rounded-xl hover:bg-gray-700 transition-colors shrink-0"
            >
              +
            </button>
          </div>
        ...
        {productos.length > 0 && (
          <div className="flex flex-wrap gap-2 mt-4">
            {productos.map((p, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-wide px-3 py-2 rounded-full"
              >
